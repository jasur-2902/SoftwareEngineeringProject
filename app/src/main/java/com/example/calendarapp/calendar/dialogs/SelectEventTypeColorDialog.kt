...
import com.example.calendarapp.calendar.extensions.calDAVHelper
...
class SelectEventTypeColorDialog(val activity: AppCompatActivity, val eventType: EventType, val callback: (color: Int) -> Unit) {
