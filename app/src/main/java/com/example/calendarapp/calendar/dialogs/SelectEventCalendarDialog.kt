...
import com.example.calendarapp.calendar.helpers.STORED_LOCALLY_ONLY
...
class SelectEventCalendarDialog(val activity: AppCompatActivity, val calendars: List<CalDAVCalendar>, val currCalendarId: Int, val callback: (id: Int) -> Unit) {
