...
import com.example.calendarapp.calendar.adapters.MyMonthPagerAdapter
import com.example.calendarapp.calendar.extensions.config
import com.example.calendarapp.calendar.extensions.getMonthCode
...
class MonthFragmentsHolder : MyFragmentHolder(), NavigationListener {
    ...
    override fun updateActionBarTitle() {
        (activity as? CalendarActivity)?.updateActionBarTitle(getString(R.string.app_launcher_name))
    }
