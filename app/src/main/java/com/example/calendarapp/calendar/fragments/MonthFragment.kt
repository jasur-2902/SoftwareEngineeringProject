...
import com.example.calendarapp.calendar.helpers.Config
import com.example.calendarapp.calendar.helpers.DAY_CODE
import com.example.calendarapp.calendar.helpers.Formatter
import com.example.calendarapp.calendar.helpers.MonthlyCalendarImpl
import com.example.calendarapp.calendar.interfaces.MonthlyCalendar
...
class MonthFragment : Fragment(), MonthlyCalendar {
    ...
    private fun updateDays(days: ArrayList<DayMonthly>) {
        mHolder.month_view_wrapper.updateDays(days) {
            (activity as CalendarActivity).openDayFromMonthly(Formatter.getDateTimeFromCode(it.code))
        }
    }
