...
import com.example.calendarapp.calendar.helpers.getNowSeconds
...
class RepeatLimitTypePickerDialog(val activity: AppCompatActivity, var repeatLimit: Long, val startTS: Long, val callback: (repeatLimit: Long) -> Unit) {
